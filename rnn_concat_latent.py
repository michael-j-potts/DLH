...
parser.add_argument('--emb_weights', type=str, default='./CAE_embedding_weights.npy',
                    help='location of the embedding weight file (default: ./CAE_embedding_weights.npy)')
...
latent_weights = pickle.load(open(args.emb_weights, 'rb'))
...
model_name = 'AE'
if args.emb_weights == './CAE_embedding_weights.npy':
	model_name = 'CAE'
...
print('Starting rnn_concat_latent training..')
...
print("RNN concatenate and latent completed in : ", int(minutes/60), " minutes and ", seconds, "seconds.")
