...
input_seqs = np.array(pickle.load(open('./MIMICIIIPROCESSED.3digitICD9.seqs', 'rb')), dtype = object)
...
print("Starting rnn_icd training: ")
...
print("RNN ICD only completed in : ", int(minutes/60), " minutes and ", seconds, "seconds.")
