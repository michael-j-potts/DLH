...
input_seqs_icd = np.array(pickle.load(open('./MIMICIIIPROCESSED.3digitICD9.seqs')))
input_seqs_meds = np.array(pickle.load(open('./MIMICIIIPROCESSED.meds.seqs')))
input_seqs_labs = np.array(pickle.load(open('./MIMICIIIPROCESSED.abnlabs.seqs')))
input_seqs_fullicd = np.array(pickle.load(open('./MIMICIIIPROCESSED.seqs')))
...
labels2 = np.array(pickle.load(open('./MIMICIIIPROCESSED.hospmorts')))
