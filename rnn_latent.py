...
print("Starting rnn_latent training")
    ...
    for epoch in range(n_epochs):
        ...
        for i in (range(0, n_iters, batchsize)):
            ...
            for iter in range(len(batch_icd)):
                ...
                hospoutputs, hosphidden = model(icd_inputs, None, force)
...
print("RNN latent only completed in : ", int(minutes/60), " minutes and ", seconds, "seconds.")
